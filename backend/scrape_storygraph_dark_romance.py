...
EXCEL_PATH = r"e:\Internship\PocketFM\Scraping_Sheet_Dark_Romance.xlsx"

def scrape_pages():
    data = []
    
    print("Starting page-by-page scraping with Playwright (Visible Browser) for Dark Romance...")
    with sync_playwright() as p:
        ...
        try:
            page_num = 1
            while page_num <= 45:
                url = f"https://app.thestorygraph.com/browse?search_term=Dark+Romance&page={page_num}"
