...
EXCEL_PATH = r"e:\Internship\PocketFM\Scraping_Sheet_Genre_4.xlsx"

def scrape_pages():
    data = []
    
    print("Starting page-by-page scraping with Playwright (Visible Browser) for Paranormal Romance...")
    with sync_playwright() as p:
        ...
        try:
            page_num = 1
            while page_num <= 200:
                url = f"https://app.thestorygraph.com/browse?search_term=Paranormal+Romance&page={page_num}"
