...
EXCEL_PATH = r"e:\Internship\PocketFM\Scraping_Sheet_Genre_5.xlsx"

def scrape_pages():
    data = []
    
    print("Starting page-by-page scraping with Playwright (Visible Browser) for Romantasy...")
    with sync_playwright() as p:
        ...
        try:
            page_num = 1
            while page_num <= 200:
                url = f"https://app.thestorygraph.com/browse?search_term=romantasy&page={page_num}"
